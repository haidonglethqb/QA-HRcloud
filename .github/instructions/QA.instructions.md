...
### 4. browsering - when in this mode you can do what you think is best to execute test case but need to follow the test case's  test steps on the test case file, do not tell me to input anything, remember you can use any tool you think is best to execute test case and remember the locator that you are using to later use in the test scripts
