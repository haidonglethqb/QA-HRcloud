...
> This folder documents who can access what in HRcloud â€” critical for test setup and bug verification.
...
3. **Verify module visibility** â€” some modules are hidden if the role doesn't have access
...
> [!WARNING]
> If a test step says "Click X" and the button isn't visible â€” the role may not have permission. Don't report as a bug without first verifying with Admin role.
