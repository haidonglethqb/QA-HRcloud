---
name: bug-report-qa
description: Create standardized and concise QA bug reports focusing on reproducibility, clarity, accurate issue description, severity, expected behavior, actual behavior, and Jira story context.
---
...
Do not assume developers understand the context â€” always align with the Jira story.
