...
**BLOCKING REQUIREMENT**: Before doing anything else, read and follow the skill file at `.codex/skills/requirement_analyze/SKILL.md`. All analysis must strictly follow the guidelines, output format, and best practices defined in that skill.
...
## Approach
1. Load `.codex/skills/requirement_analyze/SKILL.md` and follow its guidelines.
